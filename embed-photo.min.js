...
d.w=function(){Je.f.w.call(this);var a=H(this);G(a,this.c(),"mousedown",this.Yb);G(a,this.c(),"mouseenter",this.Zb);G(a,this.c(),"mouseleave",this.$b)};var Oe="flex",Pe={display:Oe,"justify-content":"center","align-items":"center",transition:"opacity 0.125s linear"},Qe={position:"relative",width:"320px",height:"320px"},Re={position:"absolute",transition:"opacity 0.250s linear",opacity:1};function Se(a,b,c){Je.call(this,a,b,c);this.s=!1}p(Se,Je);function Te(a,b){a.s=b;O(a)&&Ue(a)}function Ue(a){var b=a.s?32:48;b={width:b+"px",height:b+"px","border-radius":.5*b+"px"};E(a.b.c(),b);E(a.a.c(),b);E(a.h,b)}Se.prototype.update=function(){Ue(this);Se.f.update.call(this)};Se.prototype.u=function(){return"jx-svg-round-switch"};Se.prototype.Ba=function(){var a=this.c();P(a,this.u());E(a,Ve);a=this.b;var b=this.a;E(a.c(),We);E(b.c(),We);Hd(a,Xe);Hd(b,Xe);Se.f.Ba.call(this)};
...
d.C=function(){throw Error("Method not supported");};d.v=function(){vf.f.v.call(this);var a=this.c();this.D=D(this.i,"DIV");a.appendChild(this.D);a=this.c();P(a,this.u());E(a,Kf);a=this.fa();P(a,this.u()+"-content");E(a,Lf)};var Kf={position:"relative",overflow:"hidden"},Lf={position:"relative"},Jf={position:"absolute",opacity:1};function Mf(a){vf.call(this,a);this.h=null;this.R=Nf;this.L=Of;this.O=Pf;this.l=null}p(Mf,vf);var Of=250,Pf=.2,Nf=16;function Qf(a,b){var c=a.g.width+a.R;b*=c;c=b+c*a.h;Hf(a,L(a,a.a).c(),b,1);Hf(a,L(a,a.b).c(),c,1)}d=Mf.prototype;d.nc=function(){this.s&&(this.l&&this.o.reset(),A(this,"swipestart"))};
